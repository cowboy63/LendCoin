...
public class LCMiner {
	...
	public static final void main(final String[] args)
	{
		...
		logEvent("INFO - Parsing mining parameters...");
		parseParameters(args);
		
		Transaction tc = new Transaction("428acdddde84", "494902409865", 30, 10, 10, 100, "093034", "4309548D55");
		System.out.println(tc);
		Transaction tc2 = new Transaction(tc.exportBinary());
